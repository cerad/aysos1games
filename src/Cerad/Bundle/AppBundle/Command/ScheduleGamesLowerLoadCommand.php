...
class ScheduleGamesLowerLoadCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName       ('cerad_app:games:load_lower')
            ->setDescription('Schedule Games Lower Load')
            ->addArgument   ('filepath', InputArgument::REQUIRED, 'Load File');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $load = $this->getService('cerad_app.schedule_games_lower.load');
        
        $results = $load->process($params);
