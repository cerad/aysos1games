...
class UnapprovedPersonsListController extends MyBaseController
{
    ...
    public function createModel(Request $request)
    {
        ...
        foreach ( $persons as $person )
        {
          ...
          if ( $personFed->getfedKeyVerified() != 'Yes' or $personFed->getfedKeyVerified() != 'Verified'  )
          {
            $unapproved[] = $person;
          }
        }
